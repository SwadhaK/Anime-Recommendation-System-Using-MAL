"""
This script converts the JSON files generated by the apiDataCollector script into CSV files,
 making them compatible for use with Pandas.
"""
...
def convert_user_anime_list_json_to_csv():
    ...
    with open('data/recovered_user_anime_lists.json', 'r') as anime_json_file:
        anime_json = json.load(anime_json_file)
        for anime_list in anime_json["anime_list"]:
